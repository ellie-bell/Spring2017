...
public class Project10
{
	...
	public static ArrayList<String> foundWordList = new ArrayList<>();
   ...
   {	
		...
		if ( word.length() > 2 && dictionary.contains(word) && !foundWordList.contains(word)) 
		{
		...
		if ( (r>0) && (c<board.length-1) && board[r-1][c].equals(board[r-1][c].toLowerCase()))
		{
